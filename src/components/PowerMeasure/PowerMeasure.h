...
public:
    ...
    PowerMeasure(TwoWire& wire, uint8_t addr, unsigned sample_freq_hz);
...
public:
    SampleTimer(PowerMeasure& power_measure_ref, INA226& ina_power_ref, uint8_t unit_id_ref, unsigned interval_ms);
