...
void IMU9::SampleTimer::callback() {
  ...
  packet.append("Mx").setFloat16(Mx);
  packet.append("My").setFloat16(My);
  packet.append("Mz").setFloat16(Mz);
  packet.append("Ro").setFloat16(Ro);
  packet.append("Pi").setFloat16(Pi);
  packet.append("Ya").setFloat16(Ya);
