...
// CANBus and SerialBus are transport components. Packets received from either
// one are republished by the kernel, so no GS-specific forwarding component is
// needed between the PC serial link and CAN.
