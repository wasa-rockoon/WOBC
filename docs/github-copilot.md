...
1. GitHubにログインする
2. `GitHub Education`（Student Developer Pack）と検索して一番上の申請ページを開いて`Join GitHub Education`をクリック

![github-education](/docs/image/github-copilot/join-github-education.png)

3. 次の画面で`Start an application`をクリック

![start-an-application](/docs/image/github-copilot/start-an-application.png)

4. 学校情報を入力し、在学証明資料をアップロードする
