...
作成日：2026-07-26  
作成者：Aoyama (Gemini)  
関連：[20260618_PC_to_MCU_packet_send.md](20260618_PC_to_MCU_packet_send.md)（.command ファイルと util.py 連携の解説）
...
- [src/library/wcpp/python/send_command.py](file:///c:/Users/shoko/waseda/sa-kuru/WASA/WOBC/src/library/wcpp/python/send_command.py)
